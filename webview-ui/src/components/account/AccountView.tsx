...
import JarvisIdeLogoWhite from "../../assets/JarvisIdeLogoWhite"
import CountUp from "react-countup"
import CreditsHistoryTable from "./CreditsHistoryTable"
import { UsageTransaction, PaymentTransaction } from "../../../../src/shared/JarvisIdeAccount"
...
export const JarvisIdeAccountView = () => {
		...
		<div className="h-full flex flex-col">
			{user ? (
				<div className="flex flex-col pr-3 h-full">
					...
					<div className="w-full flex gap-2 flex-col min-[225px]:flex-row">
						<div className="w-full min-[225px]:w-1/2">
							<VSCodeButtonLink href="https://app.jarvis-ide.dev/credits" appearance="primary" className="w-full">
								Dashboard
							</VSCodeButtonLink>
						</div>
					...
					<div className="w-full flex flex-col items-center">
						...
						<div className="w-full">
							<VSCodeButtonLink href="https://app.jarvis-ide.dev/credits/#buy" className="w-full">
								Add Credits
							</VSCodeButtonLink>
						</div>
					</div>
				...
				<div className="flex flex-col items-center pr-3">
					<JarvisIdeLogoWhite className="size-16 mb-4" />
					...
					<VSCodeButton onClick={handleLogin} className="w-full mb-4">
						Sign up with Jarvis IDE
					</VSCodeButton>

					<p className="text-[var(--vscode-descriptionForeground)] text-xs text-center m-0">
						By continuing, you agree to the <VSCodeLink href="https://jarvis-ide.dev/tos">Terms of Service</VSCodeLink> and{" "}
						<VSCodeLink href="https://jarvis-ide.dev/privacy">Privacy Policy.</VSCodeLink>
					</p>
				</div>
			)}
		</div>
