...
import { JarvisCheckpointRestore } from "../../../../src/shared/WebviewMessage"
...
export const CheckpointOverlay = ({ messageTs }: CheckpointOverlayProps) => {
	...
	const handleRestoreTask = () => {
		...
		vscode.postMessage({
			...
			number: messageTs,
			text: "task" satisfies JarvisCheckpointRestore,
		})
	}
	...
	const handleRestoreWorkspace = () => {
		...
		vscode.postMessage({
			type: "checkpointRestore",
			number: messageTs,
			text: "workspace" satisfies JarvisCheckpointRestore,
		})
	}
	...
	const handleRestoreBoth = () => {
		...
		vscode.postMessage({
			type: "checkpointRestore",
			number: messageTs,
			text: "taskAndWorkspace" satisfies JarvisCheckpointRestore,
		})
	}
