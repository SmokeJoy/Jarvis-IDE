		...
		switch (type) {
			...
			case "mistake_limit_reached":
				return [
					...
					<span style={{ color: errorColor, fontWeight: "bold" }}>Jarvis IDE is having trouble...</span>,
				]
			...
			case "use_mcp_server":
				...
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold", wordBreak: "break-word" }}>
						Jarvis IDE wants to {mcpServerUse.type === "use_mcp_tool" ? "use a tool" : "access a resource"} on the{" "}
			...
			case "followup":
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>Jarvis IDE has a question:</span>,
				]
			default:
				return [null, null]
		}
				...
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("edit")}
							<span style={{ fontWeight: "bold" }}>Jarvis IDE wants to edit this file:</span>
						</div>
						<CodeAccordian
			...
			case "newFileCreated":
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("new-file")}
							<span style={{ fontWeight: "bold" }}>Jarvis IDE wants to create a new file:</span>
						</div>
						<CodeAccordian
							isLoading={message.partial}
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{/* {message.type === "ask" ? "" : "Jarvis read this file:"} */}
								Jarvis IDE wants to read this file:
							</span>
						</div>
						<div
							style={{
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Jarvis IDE wants to view the top level files in this directory:"
									: "Jarvis IDE viewed the top level files in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Jarvis IDE wants to recursively view all files in this directory:"
									: "Jarvis IDE recursively viewed all files in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Jarvis IDE wants to view source code definition names used in this directory:"
									: "Jarvis IDE viewed source code definition names used in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("search")}
							<span style={{ fontWeight: "bold" }}>
								Jarvis IDE wants to search this directory for <code>{tool.regex}</code>:
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
											...
											<p
												...
												{apiRequestFailedMessage?.toLowerCase().includes("powershell") && (
													<>
														...
														<a
															href="https://github.com/jarvis-ide/jarvis-ide/wiki/TroubleShooting-%E2%80%90-%22PowerShell-is-not-recognized-as-an-internal-or-external-command%22"
															style={{
																color: "inherit",
					...
					return (
						<>
							<div
								...
								<div>
									Jarvis IDE tried to access <code>{message.text}</code> which is blocked by the{" "}
									<code>.jarvis-ide-ignore</code>
									file.
								</div>
							</div>
						</>
					...
					return (
						<>
							<div
								...
								<div>
									Jarvis IDE won't be able to view the command's output. Please update VSCode (
									<code>CMD/CTRL + Shift + P</code> → "Update") and make sure you're using a supported shell:
									zsh, bash, fish, or PowerShell (<code>CMD/CTRL + Shift + P</code> → "Terminal: Select Default
									Profile").{" "}
									<a
										href="https://github.com/jarvis-ide/jarvis-ide/wiki/Troubleshooting-%E2%80%90-Shell-Integration-Unavailable"
										style={{
											color: "inherit",
											textDecoration: "underline",
										}}>
