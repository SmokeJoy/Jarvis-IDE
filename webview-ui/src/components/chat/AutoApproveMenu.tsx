			...
			{isExpanded && (
				<div style={{ padding: "0" }}>
					<div
						...
						Auto-approve allows Jarvis IDE to perform the following actions without asking for permission. Please use with
					...
					<div
						...
						Jarvis IDE will automatically make this many API requests before asking for approval to proceed with the task.
					</div>
					<div style={{ margin: "6px 0" }}>
						...
						<div
							...
							Receive system notifications when Jarvis IDE requires approval to proceed or when a task is completed.
						</div>
					</div>
				</div>
			)}
