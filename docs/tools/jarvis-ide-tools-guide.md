# Jarvis IDE Tools Reference Guide

## What Can Jarvis IDE Do?

Jarvis IDE is your AI assistant that can:
...
3. **Review Changes**
    - Jarvis IDE will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [Jarvis IDE repository](https://github.com/jarvis-ide/jarvis-ide).

Jarvis IDE has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that Jarvis IDE can then access
    - Example: Create a weather API tool that Jarvis IDE can use to fetch forecasts
...
-   Provide feedback to improve Jarvis IDE 