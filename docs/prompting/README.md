...
Place the `.jarvisrules` file in your project's root directory:
...
-   **Memory Check** - _pacnpal_
    ...
    A fun way to verify Jarvis IDE stays on track during complex tasks. Try "HO HO HO" for a festive twist!
