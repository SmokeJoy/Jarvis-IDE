...
import type { JarvisAgent, AgentResponse } from '../agent/JarvisAgent.js.js';
...
describe('JarvisAgent', () => {
  ...
  it('dovrebbe gestire correttamente gli errori', async () => {
    ...
    vi.mocked(sendPromptToLLMMock.sendPromptToLLM).mockRejectedValueOnce(new Error('Errore di test'));
