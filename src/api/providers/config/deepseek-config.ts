...
type ExtendedModelInfo = ModelInfo & Partial<{
    topP: number;
    presencePenalty: number;
    frequencyPenalty: number;
}>
 ...
 */
export function buildDeepSeekConfig(modelId: string, modelInfo?: ExtendedModelInfo): DeepSeekConfig {
    ...
    const config: DeepSeekConfig = {
        ...
        maxTokens: Number.isFinite(modelInfo?.maxTokens) && modelInfo!.maxTokens! > 0
