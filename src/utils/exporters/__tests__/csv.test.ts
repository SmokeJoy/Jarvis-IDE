...
import { toCSV, sessionToCSV } from '../csv';
...
describe('CSV Exporter', () => {
  ...
  const mockMessages: ChatMessage[] = [
    mockMessage('system', 'Sei un assistente AI', { timestamp: 1617876123000 }),
    mockMessage('user', 'Ciao, come stai?', { timestamp: 1617876124000 }),
    mockMessage('assistant', 'Sto bene, grazie!', { timestamp: 1617876125000 }),
    mockMessage('user', 'Dati con virgola, punto e virgola; e "virgolette"', { timestamp: 1617876126000 }),
    mockMessage('assistant', 'Riga 1\nRiga 2', { timestamp: 1617876127000 }),
  ];
