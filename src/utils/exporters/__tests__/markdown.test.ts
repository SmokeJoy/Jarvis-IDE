...
describe('toMarkdown', () => {
  const mockSession: ExportableSession = {
    messages: [
      ...
      { role: 'assistant', content: 'Salve! Sto bene, grazie. Come posso aiutarti oggi?' },
      { role: 'user', content: 'Potresti mostrarmi del codice?\n```javascript\nconst x = 10;\nconsole.log(x);\n```' },
      { role: 'assistant', content: 'Ecco un esempio:\n```python\ndef hello():\n    print("Hello world")\n```' },
      { role: 'function', content: 'Risultato dell\'esecuzione', name: 'execute_code' },
    ],
    settings: {
      temperature: 0.7,
      model: 'gpt-4',
