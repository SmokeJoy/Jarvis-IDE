...
import { JarvisIdeIgnoreController, LOCK_TEXT_SYMBOL } from "../ignore/JarvisIdeIgnoreController.js.js"
import type { ChatCompletionContentPartText, ChatCompletionContentPartImage } from "../../types/global.js.js"
...
(This is an automated message, so do not respond to it conversationally.)`,
	...
	toolResult: (text: string, images?: string[]): string | Array<ChatCompletionContentPartText | ChatCompletionContentPartImage> => {
	...
	formatFilesList: (
		...
		} else if (jarvisIdeIgnoreParsed.length === 0 || (jarvisIdeIgnoreParsed.length === 1 && jarvisIdeIgnoreParsed[0] === "")) {
