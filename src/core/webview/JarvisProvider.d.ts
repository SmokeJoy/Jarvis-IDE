...
import { ExtensionState, ExtensionMessage } from "../../shared/ExtensionMessage.js";
...
import { IJarvisProvider, ExtendedChatSettings, JarvisSettings, ConfigModelInfo, TelemetrySetting, HistoryItem } from "../../shared/types/provider.types.js";
...
export declare class JarvisProvider implements IJarvisProvider {
    ...
    constructor(context: vscode.ExtensionContext, outputChannel: vscode.OutputChannel, settings: JarvisSettings, autoApprovalSettings?: AutoApprovalSettings, customInstructions?: string, _task?: string | undefined, _images?: string[] | undefined, _historyItem?: HistoryItem | undefined, telemetryService?: TelemetryService | undefined);
    ...
    togglePlanActModeWithChatSettings(chatSettings: ExtendedChatSettings, chatContent?: unknown): Promise<void>;
