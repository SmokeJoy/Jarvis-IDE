...
import { JarvisIdeApiReqInfo, JarvisIdeMessage } from '../../shared/ExtensionMessage';
  ...
  getNewContextMessagesAndMetadata(
    ...
    if (previousApiReqIndex >= 0) {
      ...
      if (previousRequest && previousRequest.text) {
        const { tokensIn, tokensOut, cacheWrites, cacheReads }: JarvisIdeApiReqInfo = JSON.parse(
