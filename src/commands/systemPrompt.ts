...
export function registerSystemPromptCommands(context: vscode.ExtensionContext, 
provider: JarvisProvider) {
    // Comando per leggere il system prompt
    const readSystemPromptCommand = vscode.commands.registerCommand("jarvis.readSystemPrompt", async () => {
        try {
    ...
    const saveSystemPromptCommand = vscode.commands.registerCommand("jarvis.saveSystemPrompt", async () => {
    ...
    const openSystemPromptCommand = vscode.commands.registerCommand("jarvis.openSystemPromptFile", async () => {
        try {
    ...
    const setSystemPromptPathCommand = vscode.commands.registerCommand("jarvis.setSystemPromptPath", async () => {
