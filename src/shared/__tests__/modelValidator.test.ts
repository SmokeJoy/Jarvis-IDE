...
describe('Model Validators', () => {
  ...
  describe('validateModelInfoArray', () => {
    it('should filter invalid models and return valid ones', () => {
      ...
      // Should log warning
      expect(Logger.warn).toHaveBeenCalledWith('TestProvider: 2 modelli non validi sono stati filtrati');
    });
    ...
    it('should handle non-array input', () => {
      ...
      expect(Logger.warn).toHaveBeenCalledWith('TestProvider: Modelli ricevuti non sono un array valido');
    });
  });
}); 