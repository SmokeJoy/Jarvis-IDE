 ...
 * @returns A new array of JarvisMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: JarvisMessage[]): JarvisMessage[] {
	const combinedApiRequests: JarvisMessage[] = []
