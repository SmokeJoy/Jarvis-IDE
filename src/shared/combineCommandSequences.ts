import type { JarvisMessage } from "./ExtensionMessage.js.js"
 ...
 *
 * This function processes an array of JarvisMessage objects, looking for sequences
 ...
 * @returns A new array of JarvisMessage objects with command sequences combined.
 *
 * @example
 ...
 * ];
 * const combined = combineCommandSequences(messages);
 * // Result: [{ type: 'ask', ask: 'command', text: 'ls\nfile1.txt\nfile2.txt', ts: 1625097600000 }]
 */
export function combineCommandSequences(messages: JarvisMessage[]): JarvisMessage[] {
	const combinedCommands: JarvisMessage[] = []
