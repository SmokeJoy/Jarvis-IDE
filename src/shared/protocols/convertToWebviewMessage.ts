...
import type { WebviewMessage, OutgoingWebviewMessage, LegacyWebviewMessage } from './webview.protocol.js.js';
import type { validateWebviewMessage } from './validateWebviewMessage.test.js.js';
