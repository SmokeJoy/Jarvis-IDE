...
/**
 * Valida un oggetto OpenRouterModelInfo usando type guard
 * @param obj Oggetto da validare
 * @returns true se l'oggetto è un OpenRouterModelInfo valido, false altrimenti
 */
export function isOpenRouterModelInfo(obj: unknown): obj is OpenRouterModelInfo {
  return (
    typeof obj === 'object' &&
    obj !== null &&
    typeof (obj as OpenRouterModelInfo).id === 'string' &&
    typeof (obj as OpenRouterModelInfo).name === 'string' &&
    typeof (obj as OpenRouterModelInfo).context_length === 'number'
  );
}
