 ...
 */
export declare function normalizeBrowserSettings(settings?: Partial<BrowserSettings>): BrowserSettings;
/**
 ...
 */
export declare function normalizeAutoApprovalSettings(settings?: Partial<AutoApprovalSettings>): AutoApprovalSettings;
