...
export interface BlacklistMessage<T extends BlacklistMessageType> extends BaseMessage<T> {
  payload: T extends BlacklistMessageType.REQUEST_STATUS
    ? void
    : T extends BlacklistMessageType.STATUS_UPDATED
      ...
      : T extends BlacklistMessageType.REQUEST_HISTORY
        ? void
