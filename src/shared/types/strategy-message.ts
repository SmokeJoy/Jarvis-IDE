...
export interface StrategyMessage<T extends StrategyMessageType> extends BaseMessage<T> {
  payload: T extends StrategyMessageType.REQUEST_STATUS
    ? void
    : T extends StrategyMessageType.STATUS_UPDATED
      ...
      : T extends StrategyMessageType.REQUEST_CONFIG
        ? void
