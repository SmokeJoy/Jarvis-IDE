 ...
 *
 * Core implementation of Jarvis IDE's Checkpoints system that provides version control
...
class CheckpointTracker {
	 ...
	 *
	 * Configuration:
	 * - Respects 'jarvis-ide.enableCheckpoints' VS Code setting
	 */
	public static async create(taskId: string, globalStoragePath: string | undefined): Promise<CheckpointTracker | undefined> {
		...
		try {
			...
			const enableCheckpoints = vscode.workspace.getConfiguration("jarvis-ide").get<boolean>("enableCheckpoints") ?? true
