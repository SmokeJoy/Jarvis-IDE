...
import { mergePromise, TerminalProcess, TerminalProcessResultPromise } from "./TerminalProcess.js"
...
export class TerminalManager {
	...
	async getOrCreateTerminal(cwd: string): Promise<TerminalInfo> {
		...
		const matchingTerminal = terminals.find((t) => {
			...
			const terminalCwd = t.terminal.shellIntegration?.cwd // one of jarvis-ide's commands could have changed the cwd of the terminal
			if (!terminalCwd) {
				return false
			}
