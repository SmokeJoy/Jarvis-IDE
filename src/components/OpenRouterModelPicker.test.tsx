...
describe('OpenRouterModelPicker', () => {
  ...
  test('renders models correctly', () => {
    render(<OpenRouterModelPicker selectedModel="model1" onChange={() => {}} models={models} />);
  ...
  test('handles model selection correctly', () => {
    ...
    render(
      <OpenRouterModelPicker selectedModel="model1" onChange={handleChange} models={models} />
    );
  ...
  test('displays selected model correctly', () => {
    render(<OpenRouterModelPicker selectedModel="model2" onChange={() => {}} models={models} />);
