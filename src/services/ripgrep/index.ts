...
export async function regexSearchFiles(
  ...
  // Filter results using JarvisIdeIgnoreController if provided
  const filteredResults = jarvisIdeIgnoreController
    ? results.filter((result) => jarvisIdeIgnoreController.validateAccess(result.filePath))
    : results;
