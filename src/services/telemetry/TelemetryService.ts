...
/**
 * PostHogClient handles telemetry event tracking for the Jarvis IDE extension
...
class PostHogClient {
	...
	private constructor() {
		const posthogConfig = {
			api_key: "phc_Ug0YZxPQXQGYoNDwYqOPBPXXwEYdWPpVZGpkKGhGJEK",
		...
		this.client = new PostHog(posthogConfig.api_key, posthogConfig);
	}
	...
	/**
	 * Records when jarvis-ide calls the task completion_result tool signifying that jarvis-ide is done with the task
