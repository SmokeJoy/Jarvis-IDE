 ...
 */
export const refactorSnippetHandler: McpToolHandler = async (args): Promise<McpToolResult> => {
 ...
 */
function generateExplanation(objective: string, language: string): string {
  return `
