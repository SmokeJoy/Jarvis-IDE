...
function filterContexts(contexts: ContextItem[], options: ExportOptions): ContextItem[] {
...
export async function contextExportHandler(args: ExportOptions): Promise<ToolCallResult> {
  try {
