 ...
 */
function detectFormatLanguage(filePath) {
 ...
 */
async function formatWithPrettier(filePath, writeToFile) {
 ...
 */
async function formatWithBlack(filePath, writeToFile) {
 ...
 */
async function formatWithAutopep8(filePath, writeToFile) {
    try {
        if (writeToFile) {
 ...
 */
async function formatWithClangFormat(filePath, writeToFile) {
    try {
        if (writeToFile) {
 ...
 */
async function formatWithGoFmt(filePath, writeToFile) {
    try {
        if (writeToFile) {
 ...
 */
async function formatFile(filePath, language, writeToFile) {
 ...
 */
export const fsFormatHandler = async (args) => {
...
//# sourceMappingURL=fsFormatHandler.js.map