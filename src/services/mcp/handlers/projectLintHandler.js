...
async function lintPythonFile(filePath, shouldFix) {
...
function mapPylintSeverity(pylintType) {
    const severityMap = {
        'fatal': 'error',
        'error': 'error',
        'warning': 'warning',
...
async function lintJavaScriptFile(filePath, shouldFix) {
    try {
        if (!ESLint) {
...
async function lintWithEslintCli(filePath, shouldFix) {
    const execAsync = promisify(exec);
...
export const projectLintHandler = async (args) => {
...
//# sourceMappingURL=projectLintHandler.js.map